...
public class Activator extends TestActivator {
    ...
    String[] classNames = { "TestDriverVersion" };
    
    public String getTestGroupName() { return "DriverVersion"; }
    public String getTestPackage() { return "org.eclipse.gemini.jpa.test.driverversion"; }
    public String[] getTestClasses() { return classNames; }
    public void setBundleContext(BundleContext ctx) { 
        TestDriverVersion.ctx = ctx;
    }
}