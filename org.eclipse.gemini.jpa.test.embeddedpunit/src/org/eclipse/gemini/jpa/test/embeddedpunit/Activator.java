...
public class Activator extends TestActivator {
    ...
    String[] classNames = { "TestEmbeddedPUnit" };
    
    public String getTestGroupName() { return "EmbeddedPUnit"; }
    public String getTestPackage() { return "org.eclipse.gemini.jpa.test.embeddedpunit"; }
    public String[] getTestClasses() { return classNames; }
    public void setBundleContext(BundleContext ctx) { 
        TestEmbeddedPUnit.ctx = ctx;
    }
}