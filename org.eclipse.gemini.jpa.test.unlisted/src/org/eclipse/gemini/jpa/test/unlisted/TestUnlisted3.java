 ...
 * @author mkeith
 */
public class TestUnlisted3 extends JpaTest {
    
    public static final String TEST_NAME = "TestUnlisted3";
    ...
    public Object newObject() {
        UnlistedEntity3 a = new UnlistedEntity3();
        a.setId(300);
        return a;
    }
    ...
    public Object findObject() {
        ...
        Object obj = em.find(UnlistedEntity3.class, 300);        
        em.close();
        return obj;
    }

    public String queryString() {
        return "SELECT a FROM UnlistedEntity3 a";
    }        
}
