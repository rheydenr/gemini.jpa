 ...
 * @author mkeith
 */
public class TestUnlisted2 extends JpaTest {
    
    public static final String TEST_NAME = "TestUnlisted2";
    ...
    public Object newObject() {
        UnlistedEntity2 a = new UnlistedEntity2();
        a.setId(200);
        return a;
    }
    ...
    public Object findObject() {
        ...
        Object obj = em.find(UnlistedEntity2.class, 200);        
        em.close();
        return obj;
    }

    public String queryString() {
        return "SELECT a FROM UnlistedEntity2 a";
    }        
}
