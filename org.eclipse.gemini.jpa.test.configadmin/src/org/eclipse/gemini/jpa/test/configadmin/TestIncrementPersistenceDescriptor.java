 ...
 * @author mkeith
 */
public class TestIncrementPersistenceDescriptor extends JpaTest {
        
    public static final String TEST_NAME = "TestIncrementPersistenceDescriptor";
    public static final String PERSISTENCE_UNIT_UNDER_TEST = "ConfigAdminAccounts2";
