...
public class Activator extends TestActivator {
    ...
    String[] classNames = { "TestEmbeddedJdbc" };

    public String getTestGroupName() { return "EmbeddedJDBC"; }
    public String getTestPackage() { return "org.eclipse.gemini.jpa.test.embeddedjdbc"; }
    public String[] getTestClasses() { return classNames; }
    public void setBundleContext(BundleContext ctx) { 
        TestEmbeddedJdbc.ctx = ctx;
    }
}