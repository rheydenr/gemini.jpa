...
public class Activator extends TestActivator {
    ...
    String[] classNames = { "TestMultiEMFExistingProps", "TestMultiEMFNewProps" };
    
    public String getTestGroupName() { return "Multi-EMF"; }
    public String getTestPackage() { return "org.eclipse.gemini.jpa.test.multiemf"; }
    public String[] getTestClasses() { return classNames; }
    public void setBundleContext(BundleContext ctx) { 
        TestMultiEMFExistingProps.ctx = ctx;
		TestMultiEMFNewProps.ctx = ctx;
    }
}