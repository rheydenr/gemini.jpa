...
public class Activator extends TestActivator {
    ...
    String[] classNames = { "TestMappingFileElement", "TestOrmMappingFile" };
    
    public String getTestGroupName() { return "XmlMapped"; }
    public String getTestPackage() { return "org.eclipse.gemini.jpa.test.xmlmapped"; }
    public String[] getTestClasses() { return classNames; }
    public void setBundleContext(BundleContext ctx) { 
        TestMappingFileElement.ctx = ctx;
        TestOrmMappingFile.ctx = ctx;
    }
}